...
def test_premium_emphasis_from_plan(tmp_path):
    from backend.pipeline.subtitles import render_plan_subs
    plan_subs = [
        {"start": 0.0, "end": 0.3,
         "words": [{"disp": "Cette", "role": "active"}, {"disp": "Rolex", "role": "kw_idle"}]},
        {"start": 0.3, "end": 0.8,
         "words": [{"disp": "Cette", "role": "normal"}, {"disp": "Rolex", "role": "kw_active"}]},
    ]
